...
class PetFriends:
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод делает POST запрос к API сервера и добавляет новое фото указанного pet_id питомца.
    ...
    def add_new_pet_photo(self, auth_key: json, name: str, animal_type: str, age: int) -> json:
